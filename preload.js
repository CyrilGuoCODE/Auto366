...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  deleteRule: (ruleId, rulesetId = null) => ipcRenderer.invoke('delete-response-rule', ruleId, rulesetId),
  toggleRule: (ruleId, enabled, compatibilityProtectionEnabled = true, rulesetId = null) => ipcRenderer.invoke('toggle-response-rule', ruleId, enabled, compatibilityProtectionEnabled, rulesetId),
  resetRuleTriggers: (ruleId, rulesetId = null) => ipcRenderer.invoke('reset-rule-triggers', ruleId, rulesetId),
  saveResponseRules: (rules) => ipcRenderer.invoke('save-response-rules', rules),
  getEffectiveCompat: (groupId) => ipcRenderer.invoke('get-effective-compat', groupId),
